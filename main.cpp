...
/*
        //testing drop
        comp15.drop_student(Student("Green,Alice", true));
        cout<< "dropped Alice Green"<<endl;
        comp15.drop_student(Student("Fuchsia,Rebecca", false));
        cout<< "dropped Rebecca Fuchsia"<<endl;
        comp15.drop_student(Student("Red,Justin", true));
        cout<< "dropped Justin Red"<<endl;
        print_all_status(comp15);
        print_all_students(students, &comp15);
*/
